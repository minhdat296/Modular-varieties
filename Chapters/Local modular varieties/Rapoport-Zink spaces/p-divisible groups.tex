\section{\texorpdfstring{$p$}{}-divisible groups}
    \subsection{\texorpdfstring{$p$}{}-divisible groups}
        \subsubsection{Universal covers of \texorpdfstring{$p$}{}-divisible groups}
            ...
            \end{remark}
            \begin{lemma}[Extensions of \'etale finite flat commutative groups by connected finite flat groups] \label{lemma: extensions_of_etale_finite_flat_commutative_groups_by_connected_finite_flat_groups}
    ...
    \subsection{Moduli spaces of \texorpdfstring{$p$}{}-divisible groups}
        \subsubsection{Deformations of \texorpdfstring{$p$}{}-divisible groups and Gross-Hopkins Period Morphisms}
            \begin{definition}[(Quasi)-isogenies] \label{def: quasi_isogenies}
            ...
            \end{definition}
            \begin{example}[(Quasi-)isogenies between abelian varieties] \label{example: quasi_isogenies_between_abelian_varieties}
            ...
            \begin{example}[(Quasi-)isogenies between $p$-divisible groups] \label{example: quasi_isogenies_between_p_divisible_groups}
            ...
            \end{convention}
            \begin{definition}[Quasi-isogenous deformations of $p$-divisible groups] \label{def: quasi_isogenous_deformations_of_p_divisible_groups}
