\section{Perfectoid spaces}
    ...
    \subsection{Almost purity for perfectoid spaces}
        \subsubsection{\'Etale morphisms of perfectoid spaces}
            ...
            \end{theorem}
                \begin{proof}
                    ...
                    \end{enumerate}
                \end{proof}
            Being finite-\'etale for morphisms between perfectoid spaces is an entirely local phenomenon, so let us simply state it for morphisms between affinoid perfectoid spaces.
            \begin{definition}[Finite-\'etale morphisms of perfectoid spaces] \label{def: finite_etale_morphisms_of_perfectoid_spaces}
            ...
            \begin{definition}[Strongly finite-\'etale morphisms of perfectoid spaces] \label{def: strongly_finite_etale_morphisms_of_perfectoid_spaces}
